        ...
        <nav class="navbar navbar-expand-lg navbar-light bg-light">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav mr-auto">
                    ...
                    <li class="nav-item">
                        <a class="nav-link selected" href="RequestCompleted.jsp">Request Completed</a>
                    </li>
                </ul>
    ...
    <section id="navigator">
        <div class="container">
            <div class="path">
                ...
                <div class="path-directio" style="color: grey; display:inline-block;"> / Request Completed</div>
            </div>
